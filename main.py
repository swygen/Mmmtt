...
async def refer_earn(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(
        msg, reply_markup=InlineKeyboardMarkup(InlineKeyboardButton("🔙 Back", callback_data="back"))
    )
...
async def tips_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    tips = {
        "tip_gmail": ("📱 মোবাইল ফোন এর মাধ্যমে জিমেইল একাউন্ট তৈরি করে বিক্রি করুন", "https://link1.com"),
        "tip_whatsapp": ("📱 মোবাইল ফোন এর মাধ্যমে Whatsapp একাউন্ট তৈরি করে বিক্রি করুন", "https://link2.com"),
        "tip_bdtgame": ("📱 মোবাইল ফোন এর মাধ্যমে BDT GAME খেলে টাকা উপার্জন করুন", "https://link3.com"),
        "tip_webapp": ("সকল প্রকার Web+App তৈরি করে ইনকাম শুরু করুন", "https://link4.com"),
    }
...
async def support(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.callback_query.edit_message_text(
        "যেকোনো সমস্যা হলে যোগাযোগ করুন: https://t.me/U011111111",
        reply_markup=InlineKeyboardMarkup(InlineKeyboardButton("🔙 Back", callback_data="back")),
    )
